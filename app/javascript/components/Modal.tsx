      ...
      {props.showFlag ? (
        <>
          ...
          <div className="flex justify-center">
            <div className="modal-window block p-6 rounded-lg shadow-lg bg-white max-w-sm">
